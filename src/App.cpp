...
void App::_updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.proj[1][1] *= -1;  // flip y coordinate since glm was made for OpenGL and Y coordinate is inverted in Vulkan
